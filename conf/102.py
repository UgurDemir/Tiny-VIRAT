opt = {
    ...
    'gan1': {
        ...
        'netG': {
            ...
            'model': {
                'arch': 'g6', 'attn':None, 'ngf':32, 'nbf':16, 'nblock':4, 'nup':3, 'acto':'tanh', 'norm':'spec', 'conv_mode':'3D',
            ...
            'loss': {
                ...
                'adv': {'wt': 0.01},
                #'adv_seg': {'wt': 0.2},
                #'feat':{'wt':0.1, 'model':'i3d', 'layers':[('incep3c',1.0),('incep4f', 1.0), ('incep5c', 1.0)], 'loss':'l1', 'model_path':'/home/ugur/Documents/weights/i3d/converted_i3d_rgb_charades.pt'},
        ...
        'netD': {
            ...
            'model':{'arch':'d4', 'ndf':16, 'nlayer':5, 'actc':'lrelu', 'acto':None, 'norm':None, 'conv_mode': '3D'},
