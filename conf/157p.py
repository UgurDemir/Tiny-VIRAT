opt = {
    ...
    'scale_shift': {
        1:{'erange': (0 , 1 ), 'nfade':0, 'batch_size': 128, 'prog_size':[4,  14,  14]},
        2:{'erange': (1, 40 ), 'nfade':2, 'batch_size': 128, 'prog_size':[4,  28,  28]},
        3:{'erange': (40, 60 ), 'nfade':2, 'batch_size': 96, 'prog_size':[8,  28,  28]},
        4:{'erange': (60, 80 ), 'nfade':2, 'batch_size': 96, 'prog_size':[8,  56,  56]}, 
        5:{'erange': (80, 100), 'nfade':2, 'batch_size': 64,  'prog_size':[16, 56, 56]},
        6:{'erange': (100, 500), 'nfade':2, 'batch_size': 18,  'prog_size':[16, 112, 112]}
    },
    ...
    'gan1': {
        ...
        'netG': {
            ...
            'model': {
                ...
                'arch': 'pg2', 'mode': 'ST', 'scale_factor':8,  'ngf':32, 'nbf':32,  'norm':None, 'conv_mode':'3D',
            },
            ...
            'resume': '/home/ugur/Documents/repo/vidres/_results/157p/model/chk_prog_sr_scale6_117.pth.tar'
        }, 
