opt = {
    ...
    'scale_shift': {
        1:{'erange': (0 , 40 ), 'nfade':0, 'batch_size': 48, 'prog_size':[8,  56,  56]}, 
        2:{'erange': (40, 500), 'nfade':2, 'batch_size': 28,  'prog_size':[16, 112, 112]}
    },
    ...
    'gan1': {
        ...
        'netG': {
            ...
            'model': {
                ...
                'arch': 'pg3', 'mode': '3D', 'scale_factor':4,  'ngf':16, 'nbf':16,  'norm':None, 'conv_mode':'3D',
            },
