opt = {
    ...
    'scale_shift': {
        ...
        2:{'erange': (30, 60 ), 'nfade':2, 'batch_size': 64, 'prog_size':[8,  56,  56]},
        3:{'erange': (60, 500), 'nfade':2, 'batch_size': 24, 'prog_size':[16,  112,  112]},
    },
    ...
    'gan1': {
        ...
        'netG': {
            ...
            'model': {
                ...
                'arch': 'pg2', 'mode': '3D', 'scale_factor':8,  'ngf':32, 'nbf':32,  'norm':None, 'conv_mode':'3D',
            },
            ...
            'resume': '/home/ugur/Documents/repo/vidres/_results/162p/model/chk_prog_sr_scale3_149.pth.tar'
        }, 
