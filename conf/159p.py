opt = {
    ...
    'scale_shift': {
        1:{'erange': (0 , 40 ), 'nfade':0, 'batch_size': 64, 'prog_size':[8,  56,  56]}, 
        2:{'erange': (40, 500), 'nfade':2, 'batch_size': 20,  'prog_size':[16, 112, 112]}
    },
    ...
    'gan1': {
        ...
        'netG': {
            ...
            'resume': '/home/ugur/Documents/repo/vidres/_results/159p/model/chk_prog_sr_scale2_117.pth.tar'
        }, 
