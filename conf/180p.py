opt = {
    ...
    'scale_shift': {
        1:{'erange': (0 , 30 ), 'nfade':0, 'batch_size': 128, 'prog_size':[4,  28,  28]},
        2:{'erange': (30, 60 ), 'nfade':2, 'batch_size': 96, 'prog_size':[8,  56,  56]},
        3:{'erange': (60, 500), 'nfade':2, 'batch_size': 36, 'prog_size':[16,  112,  112]},
    },
    ...
    'gan1': {
        ...
        'netG': {
            ...
            'model': {
                ...
                'arch': 'pg3', 'mode': '3D', 'scale_factor':8,  'ngf':16, 'nbf':16,  'norm':None, 'conv_mode':'3D',
            },
            ...
            #'resume': '/home/ugur/Documents/repo/vidres/_results/166p/model/chk_prog_sr_scale5_81.pth.tar'
            'resume': '/home/ugur/Documents/repo/vidres/_results/180p/model/chk_prog_sr_scale2_41.pth.tar'
        }, 
