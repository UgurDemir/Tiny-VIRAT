opt = {
    ...
    'scale_shift': {
        1:{'erange': (0 , 1 ), 'nfade':0, 'batch_size': 128, 'prog_size':[8,  28,  28]},
        2:{'erange': (1, 60 ), 'nfade':2, 'batch_size': 128, 'prog_size':[8,  56,  56]}, 
        3:{'erange': (60, 90 ), 'nfade':2, 'batch_size': 64,  'prog_size':[16, 56, 56]},
        4:{'erange': (90, 500), 'nfade':2, 'batch_size': 16,  'prog_size':[16, 112, 112]}
    },
    ...
    'gan1': {
        ...
        'netG': {
            ...
            'model': {
                ...
                'arch': 'pg2', 'mode': 'ST', 'scale_factor':4,  'ngf':32, 'nbf':32,  'norm':None, 'conv_mode':'3D',
            },
            ...
            'resume': '/home/ugur/Documents/repo/vidres/_results/156p/model/chk_prog_sr_scale4_95.pth.tar'
        }, 
