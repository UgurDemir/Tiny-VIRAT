opt = {
    ...
    'scale_shift': {
        ...
        2:{'erange': (1, 40 ), 'nfade':2, 'batch_size': 22, 'prog_size':[4,  28,  28]},
        3:{'erange': (40, 60 ), 'nfade':2, 'batch_size': 22, 'prog_size':[8,  28,  28]},
        4:{'erange': (60, 80 ), 'nfade':2, 'batch_size': 16, 'prog_size':[8,  56,  56]}, 
        5:{'erange': (80, 100), 'nfade':2, 'batch_size': 16,  'prog_size':[16, 56, 56]},
        6:{'erange': (100, 500), 'nfade':2, 'batch_size': 16,  'prog_size':[16, 112, 112]}
    },
    ...
    'gan1': {
        ...
        'netG': {
            ...
            'resume': '/home/ugur/Documents/repo/vidres/_results/161p/model/chk_prog_sr_scale2_25.pth.tar'
        }, 
