opt = {
    ...
    'scale_shift': {
        ...
        2:{'erange': (1, 60 ), 'nfade':2, 'batch_size': 22, 'prog_size':[8,  56,  56]}, 
        3:{'erange': (60, 90 ), 'nfade':2, 'batch_size': 22,  'prog_size':[16, 56, 56]},
    ...
    'gan1': {
        ...
        'netG': {
            ...
            'resume': '/home/ugur/Documents/repo/vidres/_results/160p/model/chk_prog_sr_scale2_45.pth.tar'
        }, 
