opt = { 
    ...
    'netA': {
        ...
        #'resume': '/home/ugur/Documents/repo/vidres/_results/209sa/model/ac/chk_ac_best.pth.tar'
    ...
    'gan1': {
        ...
        'netG': {
            ...
            'model': {
                ...
                'arch': 'locpg2', 'mode': '3D', 'scale_factor':4,  'ngf':32, 'nbf':32,  'norm':None, 'conv_mode':'3D',
            },

            'optim': {'method': 'Adam', 'lr': 0.0002, 'betas': (0.5, 0.9), 'weight_decay':0.0000005},
            'lr_schedule': {'method': 'ExponentialLR', 'gamma': 1.0},
            'loss': {
            ...
            'load': '/home/ugur/Documents/repo/vidres/_results/155p/model/chk_prog_sr_scale2_best.pth.tar'
        }, 
    ...
    'image_freq': 10, # [iter]
    'val_freq': 1, # [epoch]
    'val_image_freq': 1, # 1: means save every validation images for each epoch [iter]
    'val_print_freq': 40, # [iter]
    'log_freq': 1, # Save network weigth distrubutinons [epoch]
    'save_freq': 1 # Model saving frequency [epoch]
}
