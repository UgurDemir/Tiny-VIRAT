opt = {
    ...
    'gan1': {
        ...
        'netG': {
            ...
            'model': {
                #'arch': 'g6', 'attn':None, 'ngf':32, 'nbf':16, 'nblock':4, 'nup':3, 'vdsr':False, 'acto':'tanh', 'norm':'spec', 'conv_mode':'3D',
            ...
            'resume': '/home/ugur/Documents/repo/vidres/_results/178p/model/chk_prog_sr_scale3_best.pth.tar'
        }, 
