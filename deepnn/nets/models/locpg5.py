...
class LOCPG5(nn.Module):
    def __init__(self, nch=32, actenc='lrelu', actdec='lrelu', acto='tanh', norm='spec', conv_mode='3D'):
        ...
        self.saliency_dec = nn.Sequential(
            ConvST3d(8*nch, 2*nch, (3,3,3), padding=(1,1,1), scale_mode='trilinear', scale_factor=(2,2,2), act=actdec, norm='bn', conv_mode=conv_mode),
            ConvST3d(2*nch, nch, (3,3,3), padding=(1,1,1), scale_mode='trilinear', scale_factor=(2,2,2), act=actdec, norm='bn', conv_mode=conv_mode),
            ConvST3d(nch, 1, (3,3,3), padding=(1,1,1), scale_mode='trilinear', scale_factor=(2,2,2), act='sigmoid', norm=None, conv_mode=conv_mode)
        )
