# Taken from https://github.com/kenshohara/3D-ResNets-PyTorch/blob/master/models/wide_resnet.py
import torch
...
def resnet50(num_classes=400, shortcut_type='B', k=2, sample_size=112, sample_duration=16):
    """Constructs a ResNet-50 model.
    """
    model = WideResNet(WideBottleneck, [3, 4, 6, 3], sample_size, sample_duration, k, shortcut_type, num_classes)
    return model